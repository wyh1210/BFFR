...
class FusionEvalHook(_EvalHook):
    ...
    def _do_evaluate(self, runner):
        ...
        from mmseg.apis import single_gpu_test_fusion
        results = single_gpu_test_fusion(
            runner.model, self.dataloader, show=False, out_dir=self.out_dir, pre_eval=self.pre_eval)
