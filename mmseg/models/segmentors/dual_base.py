...
class DualBaseSegmentor(BaseModule, metaclass=ABCMeta):
    """Base class for segmentors."""

    def __init__(self, init_cfg=None):
        super(DualBaseSegmentor, self).__init__(init_cfg)
    ...
    @abstractmethod
    def forward_train(self, img1, img2, img_metas, **kwargs):
        """Placeholder for Forward function for training."""
        pass

    @abstractmethod
    def simple_test(self, img1, img2, img_meta, **kwargs):
