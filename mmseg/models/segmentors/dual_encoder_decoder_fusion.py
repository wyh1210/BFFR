...
class DualEncoderDecoderFusion(DualBaseSegmentor):
    ...
    def __init__(self,
                ...
                #  auxiliary_head=None,
                 ...
                 pretrained=None,
                 init_cfg=None):
        super(DualEncoderDecoderFusion, self).__init__(init_cfg)
        if pretrained is not None:
            assert backbone.get('pretrained') is None, \
                'both backbone and segmentor set pretrained weight'
            backbone.pretrained = pretrained
        self.backbone_rgb = builder.build_backbone(backbone)
        self.backbone_ir = builder.build_backbone(backbone)
        # print(fusion)
        # exit()
    ...
    def extract_feat(self, img_rgb, img_ir):
        ...
        x1 = self.backbone_rgb(img_rgb)
        x2 = self.backbone_ir(img_ir)
        # for i in x1:
        #     print(i.shape)
