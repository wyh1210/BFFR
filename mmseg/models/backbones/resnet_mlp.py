...
class ResNet_mlp(BaseModule):
    ...
    def __init__(self,
                 ...
                 pretrained=None,
                 init_cfg=None):
        super(ResNet_mlp, self).__init__(init_cfg)
        ...
        self.layers = self.res_layers
        # for i, layer_name in enumerate(self.res_layers):
        #     print(f'layer{i}, layer_name:{self.res_layers}')
        self._freeze_stages()
    ...
    def train(self, mode=True):
        ...
        freezed."""
        super(ResNet_mlp, self).train(mode)
        self._freeze_stages()
...
@BACKBONES.register_module()
class ResNetV1c_mlp(ResNet_mlp):
    ...
    def __init__(self, **kwargs):
        super(ResNetV1c_mlp, self).__init__(
            deep_stem=True, avg_down=False, **kwargs)


@BACKBONES.register_module()
class ResNetV1d_mlp(ResNet_mlp):
    ...
    def __init__(self, **kwargs):
        super(ResNetV1d_mlp, self).__init__(
