...
class EfficientMultiheadAttention(MultiheadAttention):
    ...
    def forward(self, x, hw_shape, identity=None):
        ...
        # print(f'mit: x_q={x_q.shape},x_kv={x_kv.shape}')
...
class MixVisionTransformerFusion(BaseModule):
    ...
    def __init__(self,
                 ...
                 init_cfg=None,
                 with_cp=False):
        super(MixVisionTransformerFusion, self).__init__(init_cfg=init_cfg)
    ...
    def init_weights(self):
        if self.init_cfg is None:
            ...
            super(MixVisionTransformerFusion, self).init_weights()
    ...
    def train(self, mode=True):
        ...
        freezed."""
        super(MixVisionTransformerFusion, self).train(mode)
        self._freeze_stages()
