...
from mmseg.core import FusionEvalHook
...
def train_fusion(model,
    ...
    # register eval hooks
    if validate:
        val_dataset = build_dataset(cfg.data.visual, dict(test_mode=True))
        ...
        # eval_hook = DistEvalHook if distributed else FusionEvalHook
        eval_hook = FusionEvalHook
